...
清风雀神［叫牌］ 杠6条(自)                （共 3 分）   第 3~6 行：自己 → 对家 → 上家 → 下家
对家［叫牌］ 幺鸡(金)×1，乌骨鸡×2         （共 4 分）      行尾「（共 N 分）」右对齐
上家［叫牌］ 幺鸡(金)×2，乌骨鸡×2         （共 6 分）
下家［未叫］
三家→清风雀神自摸（共 2 分）             胡牌收付：谁付给谁 · 多少分
杠牌 三家→清风雀神（共 3 分）            杠的收付：谁付给谁 · 每个豆 3 分
...
3. **行尾「（共 N 分）」（右对齐）** —— 这一家**名下能收的分** = 鸡分 + 杠分（每个豆 3 分）。
   胡牌那几分**不在这里**（见下一条）；未叫家持有冲锋鸡时是负数（那是他赔出去的）。
4. **胡牌收付行** —— `上家点炮→下家胡牌（共 1 分）`；自摸写 `三家→X自摸（共 2 分）`；
   抢杠 / 热炮把方式写在箭头左边。
5. **杠的收付行** —— `杠牌 三家→X（共 3 分）` 是自杠（其他三家各付 3）、
   `杠牌 上家→X（共 3 分）` 是点豆（只有放杠那家付）；杠家没叫牌时反过来倒赔。
