...
| **金鸡** | 本局**翻牌的下一张**是 幺鸡 / 8筒 时，该牌种全场升级（**2 分/张**）。翻到 **9条** → 金幺鸡；翻到 **7筒** → 金乌骨鸡。 |
...
| 2 | **叫牌家**的牌河（自己打出的） | 他自己 |
| 3 | **未叫家**的牌河（打出的），**且是 幺鸡 / 8筒** | **每一个叫牌家**各一份（这就是「包鸡」） |
...
- **翻牌的下一张才是本局的金鸡牌**：翻到 **9条** → 下一张是幺鸡 → 幺鸡全场 **2 分/张**；
  翻到 **7筒** → 下一张是 8筒 → 8筒全场 **2 分/张**；其它牌 → 本局无金鸡，都照常 **1 分/张**。

### 5-3 冲锋鸡

- **身份**：**每个牌种各一只** —— 本局**第一张**被打出的**幺鸡**（一只）、本局**第一张**被打出的**乌骨鸡**（一只）。
  两只可以属同一家（那就合并算）。
- **分值**：每只 **2 分**；该只所属牌种本局是**金鸡** → 该只 **4 分**。
